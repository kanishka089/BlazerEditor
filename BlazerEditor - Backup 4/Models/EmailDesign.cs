...
public class Column
{
    ...
    // Support for nested sub-columns
    [JsonPropertyName("subColumns")]
    public List<SubColumn>? SubColumns { get; set; }

    [JsonPropertyName("subColumnWidths")]
    public List<int>? SubColumnWidths { get; set; }

    // Helper property to check if this column has sub-columns
    [JsonIgnore]
    public bool HasSubColumns => SubColumns?.Any() == true;
}
